  ...
  return (
      <div className="columns margin-perso">
        <div className="column col-6 col-lg-auto">
          <p className="mb-0 pt-2 text-normal">📍 Curienne, FR 🇫🇷</p>
        ...
        <div className="column col-sm-12 col-md-6">
          ...
          <div className={`${styles.circle} ${styles.radiusu} my-2 p-centered`}>
            <div className={styles.stack}>
              <img src="/logo/symfony.png" alt="symfony" className="img-responsive resize-img float-left m-2"/>
              ...
              <img src="/logo/strapi.webp" alt="strapi" className="img-responsive resize-img float-right m-2"/>
            </div>
          ...
          <div className="columns m-2 p-2">
            <div className="column col-6 col-lg-auto">
              <div className={`${styles.circle} ${styles.radiusd} my-2 p-centered`}>
                <div className={styles.stack}>
                  <img src="/logo/css.png" alt="sql" className="img-responsive resize-img float-left mt-2"/>
            ...
            <div className="column col-6">
              <div className={`${styles.circle} ${styles.radiust} my-2 p-centered`}>
                <div className={styles.stack}>
                  <img src="/logo/next.png" alt="next" className="img-responsive resize-img float-right m-2"/>
                  <img src="/logo/nuxt.png" alt="nuxt" className="img-responsive resize-img float-left m-2"/>
